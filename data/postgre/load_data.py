...
USAGE
  python db/load_data.py --csv-dir "/users/dfave/repos/compass_project/data/full"
...
EXAMPLES
  ...
  # Windows
  python db\\load_data.py --csv-dir "C:\\Users\\dfave\\repos\\compass_project\\data\\full" --user postgres
